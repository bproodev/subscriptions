...
namespace BprooDev\Subscriptions\Traits;

use Carbon\Carbon;
use BprooDev\Subscriptions\Models\Plan;
use BprooDev\Subscriptions\Services\Period;
...
trait HasPlanSubscriptions
{
    ...
    {
        return $this->morphMany(config('bproodev.subscriptions.models.plan_subscription'), 'subscriber', 'subscriber_type', 'subscriber_id');
    }
     ...
     *
     * @return \BprooDev\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): Collection
    {
        ...
        return app('bproodev.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \BprooDev\Subscriptions\Models\PlanSubscription
     */
